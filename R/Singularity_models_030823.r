...
LGM_climate <- CHELSA_LGM_grid[, c(21, 2:20)]
  write.csv(LGM_climate, "../CHELSA_PRESENT_LGM_GRID2.csv")
...
alitude_ <- altitude_grid[, c(3,2)]
  write.csv(alitude_modified, "../ALTITUDE_GRID2.csv")
